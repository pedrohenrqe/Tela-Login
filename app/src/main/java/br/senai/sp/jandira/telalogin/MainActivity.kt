    ...
    Column(
        ...
        Column (
            ...
            Box(modifier = Modifier
                ...
                Box(modifier = Modifier){
                    Image(
                        painter = painterResource(id = br.senai.sp.jandira.telalogin.R.drawable.eclipse),
                        contentDescription = "",
                ...
                Image(
                    painter = painterResource(id = br.senai.sp.jandira.telalogin.R.drawable.vectorcam),
